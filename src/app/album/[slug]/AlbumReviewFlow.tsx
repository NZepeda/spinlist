...
function AlbumDetailsColumn({
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.75rem] border border-border/70 bg-surface/95 p-4 shadow-[0_24px_80px_var(--brand-shadow-soft)] backdrop-blur sm:p-6 xl:rounded-[2rem] xl:p-8">
