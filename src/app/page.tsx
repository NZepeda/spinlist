    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span className="ml-2 text-lg font-bold">AlbumPulse</span>
        </Link>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  Keep a record of the albums you've listened to and want to
                  hear.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  Follow other users and discover new music through their
                  ratings.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Join AlbumPulse Today
                </h2>
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Start your musical journey. Rate albums, discover new music,
