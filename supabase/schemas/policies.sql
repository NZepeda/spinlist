...
CREATE POLICY "Album artists are viewable by everyone" ON "public"."album_artists" FOR SELECT USING (true);
CREATE POLICY "Anyone can create album artists" ON "public"."album_artists" FOR INSERT WITH CHECK (true);
CREATE POLICY "Anyone can update album artists" ON "public"."album_artists" FOR UPDATE USING (true) WITH CHECK (true);
...
CREATE POLICY "Review revisions are viewable by everyone" ON "public"."review_revisions" FOR SELECT USING (true);
